...
public class User implements Serializable {
    ...
    public User(Long id, String name, String email, String phone, LocalDate dtSubscription, LocalDate dtExpiration,
                UserType userType, SubscriptionType subscriptionType) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.phone = phone;
